## Welcome to the Nuapay swagger specification
...
#### API Docs
Our API specification is available at the following link. [Click here for the API documentation](https://sentenial.github.io/nuapay-swagger/docs/redoc.html). 
